...
describe("RequestOperationControl", () => {
  it("shows a picker and links the selected operation when unlinked and the caller can manage", async () => {
    ...
    render(<RequestOperationControl requestId="request-1" relatedOperationId={null} canManage />);
  ...
  it("shows the linked operation's title and unlinks it when the caller can manage", async () => {
    ...
    render(<RequestOperationControl requestId="request-1" relatedOperationId="op-1" canManage />);
  ...
  it("shows the linked operation without an unlink button when the caller cannot manage", async () => {
    ...
    render(<RequestOperationControl requestId="request-1" relatedOperationId="op-1" canManage={false} />);
  ...
  it("renders nothing when unlinked and the caller cannot manage", () => {
    ...
    const { container } = render(
      <RequestOperationControl requestId="request-1" relatedOperationId={null} canManage={false} />
    );
